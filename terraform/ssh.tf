...
# ANSSI R14 : Authentification par cle, sans mot de passe
# fix(ssh): root cause #3 - authorized_keys vide sur VMs
#
# Architecture :
#   tls_private_key azurerm_key_vault_secret (cle privée)
#   tls_private_key.public_key_openssh admin_ssh_key des VMs
# ============================================================

# Génération de la paire de cles SSH (Ed25519) - ANSSI R14 ────────────────────────────
...
# Stockage de la cle privée dans Key Vault ────────────────────────────────
...
# Stockage de la cle publique dans Key Vault (référence) ──────────────────
