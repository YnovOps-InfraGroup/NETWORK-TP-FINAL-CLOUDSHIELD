...
- <i class="fa-solid fa-book"></i> **Référence Technique**
  - [<i class="fa-brands fa-hashicorp"></i> Commandes Terraform](COMMANDES-TERRAFORM.md)
  - [<i class="fa-brands fa-microsoft"></i> Commandes Azure CLI](COMMANDES-AZURE-CLI.md)

- <i class="fa-solid fa-coins"></i> **FinOps**
  - [<i class="fa-solid fa-chart-line"></i> Stratégie & Coûts](STRATEGIE-FINOPS.md)

- <i class="fa-solid fa-link"></i> **Liens**
  - [<i class="fa-brands fa-github"></i> Repository GitHub](https://github.com/YnovOps-InfraGroup/NETWORK-TP-FINAL-CLOUDSHIELD)
  - [<i class="fa-solid fa-file-pdf"></i> Export PDF](CloudShield.pdf)
